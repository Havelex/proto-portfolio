...
are whole monoliths, older than all the books discovered, dedicated to the **Lopum Isid**, but even
more venerable are the cave paintings and relics from most primitive times, that clearly depict some
sort of deity that can be connected to the **Lopum Isid**.
...
That was, until the **Grimace** _blessed_ us all with the **"Secrilum"**. Or so the alphas always preach.
The **Secrilum**. A multidimensional relic, containing virtually infinite knowledge and history,
...
itself. Whatever may be the origin of the **Secrilum**, its integrity was recognized by everyone,
...
enough. Many people converted to **Skibidism**, as they deemed the **Secrilum** as sufficient proof that
...
spawning of the **Secrilum** that the whole world fell under \*\*\*\* control and became a
Theocracy.

And so it has been for eons. On top the **vortema**, _closest_ to the **Lopum Isid** and reigning over
everything. Under their direct command follow the **rumega**. They speak to the public and bring it
the words of the alphas. Additionally, they give orders to the next lower rank in the chain of
command, the **trientri**, who are there to propagate all directives and holy messages to the smaller
provinces, which are not significant enough to be worth to be visited by a **rumex**.  
Moreover, they have additional responsibilities, such as executing the laws made by the **alphas**
and **rumega**. This means that they have high positions in economics, law enforcement and military.
Henceforth, every CEO in a company, General on a base and Captain on a precinct is naturally a
**trientri**. This enables the **rumega** and especially the **vortema** to easily control the middle and
lower class and surveil the population.  
The **quamei** compose the middle class, as they are the employees, soldiers and police officers,
who the **trientri** command.  
Last and certainly least in the eyes of society are the **exidem**. They are the lower class, and
although they are technically not in the chain of command, it has established itself, that
**exidem** are inferior to **quamei**.
